...
const AI_MODELS = [
  ...
  // OpenAI (Premium)
  { value: "gpt-4o", label: "GPT-4o (Potente)", provider: "openai" },
  { value: "gpt-4o-mini", label: "GPT-4o Mini (Rápido y Económico)", provider: "openai" },
  { value: "gpt-4-turbo", label: "GPT-4 Turbo", provider: "openai" },
  { value: "gpt-3.5-turbo", label: "GPT-3.5 Turbo", provider: "openai" },
  // Gemini (Premium)
  { value: "gemini-1.5-pro", label: "Gemini 1.5 Pro", provider: "gemini" },
  { value: "gemini-1.5-flash", label: "Gemini 1.5 Flash (Rápido)", provider: "gemini" },
...
export default function ChatbotEditor() {
  ...
  const form = useForm<ChatbotFormValues>({
    ...
    values: chatbot ? {
      ...
      aiModel: chatbot.aiModel || "gpt-4o-mini",
              ...
              <div className="relative h-[500px] rounded-lg border bg-muted/30 overflow-hidden">
                <ChatWidget
                  chatbot={{
                    ...
                    aiModel: watchedValues.aiModel || "gpt-4o-mini",

              ...
              <div className="relative h-[500px] rounded-lg border bg-muted/30 overflow-hidden">
                <ChatWidget
                  chatbot={{
                    ...
                    mysqlSyncEnabled: chatbot?.mysqlSyncEnabled ?? false,
                    mysqlHost: chatbot?.mysqlHost || null,
                    mysqlPort: chatbot?.mysqlPort || 3306,
                    mysqlDatabase: chatbot?.mysqlDatabase || null,
                    mysqlUser: chatbot?.mysqlUser || null,
                    mysqlPasswordEncrypted: null,
                    mysqlSyncIntervalMinutes: chatbot?.mysqlSyncIntervalMinutes || 15,
                    mysqlLastSyncedAt: chatbot?.mysqlLastSyncedAt || null,
